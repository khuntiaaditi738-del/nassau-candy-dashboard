...
# ============================================================
# STEP 3: CREATE LEAD TIME COLUMN
# Lead Time = number of days between Order Date and Ship Date
# ============================================================
df["Lead Time"] = (df["Ship Date"] - df["Order Date"]).dt.days
df = df[df["Lead Time"] >= 0]   # remove negative values only
...
# ============================================================
# STEP 4: SPEED TIER
# Fast = under 1000 days | Medium = 1000-1400 | Slow = over 1400
# ============================================================
...
route_summary.columns = ["Route", "Average Lead Time",
                          "Total Orders", "Variability"]

# Only keep routes with 10 or more orders
route_summary = route_summary[route_summary["Total Orders"] >= 10]

print(f"\n=== ROUTES WITH 10+ ORDERS: {len(route_summary)} ===")
...
# Delayed = lead time over 1400 days (Slow cluster)
# ============================================================
...
print("\nDone! Both charts saved in your Shipping_Project folder.")